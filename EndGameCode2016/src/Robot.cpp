...
void Robot::RobotInit() {
	...
	senSC->AddDefault("Normal sensitivity (Default)", new sensitivityFalse());
	senSC->AddObject("Lower sensitivity", new sensitivityTrue());
	//make senSC viewable on dash
	SmartDashboard::PutData("Sensitivity", senSC);

	//setting up sensitivity SC
	afterSC = new SendableChooser();
	//adding all options to choose to senSC
	afterSC->AddDefault("Stop (Default)", new After1());
	afterSC->AddObject("Attempt shot", new After2());
	afterSC->AddObject("Defeat current defense", new After3());
	afterSC->AddObject("Attempt breaching right defense", new After4());
	afterSC->AddObject("Attempt breaching left defense", new After5());
	//make senSC viewable on dash
	SmartDashboard::PutData("After outer-works", afterSC);
...
void Robot::DisabledPeriodic() {
	...
	Command* temp4 = (Command*) afterSC->GetSelected();
