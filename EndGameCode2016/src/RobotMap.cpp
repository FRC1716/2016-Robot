...
void RobotMap::init() {
    ...
    driveSubsystemLeftControl.reset(new Talon(0));
        ...
        driveSubsystemLeftDrive->SetContinuous(false);
        driveSubsystemLeftDrive->SetAbsoluteTolerance(0.2);
        ...
        driveSubsystemRightDrive->SetContinuous(false);
        driveSubsystemRightDrive->SetAbsoluteTolerance(0.2);
