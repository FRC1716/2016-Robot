...
void DriveToDefense::Execute() {
	Robot::driveSubsystem->leftEncoder->Reset(); //Reset encoders
	Robot::driveSubsystem->rightEncoder->Reset();
	while ((Robot::driveSubsystem->leftEncoder->PIDGet() < (Robot::driveSubsystem->ticksPerRev * 6.8)) && (Robot::driveSubsystem->rightEncoder->PIDGet() < (Robot::driveSubsystem->ticksPerRev * 6.8))){
