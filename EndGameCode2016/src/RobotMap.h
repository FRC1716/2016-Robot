...
public:
	...
	static std::shared_ptr<SpeedController> controlSSleftFrontM;
	static std::shared_ptr<SpeedController> controlSSleftRearM;
	static std::shared_ptr<SpeedController> controlSSrightFrontM;
	static std::shared_ptr<SpeedController> controlSSrightRearM;
